...
*	we need a separate Model matrix - it can approximate normal matrix
*/
...
//tbn = InvTBNMat;
    ...
    eye_dir_var = tbn * normalize(EyePosObj - position);
	lit_dir_var = tbn * normalize(SunPosObj - position);
}